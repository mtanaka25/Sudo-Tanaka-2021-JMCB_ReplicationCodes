...
//Observation variables
  var dy_obs dI_obs dc_obs dN_obs dw_obs pi_obs r_obs rL_obs EXPr1_obs 
      EXPr2_obs EXPr3_obs EXPr4_obs dbLCB_obs eps_QE_obs eps_QEs_obs;

//Exogenous variables
  varexo eps_a_u eps_a_r eps_QE eps_QEs eps_z eps_zl eps_zeta eps_r eps_bL 
         eps_g eps_mu eps_lmbdp eps_lmbdw eps_r1 eps_r2 eps_r3 eps_r4;
...
//Structual parameters
  parameters sigmau sigmar h nu omega tau1_p tau2_p tau3_p psi eta
...
estimated_params;
  // structual parameters
    ...
    zetap   ,   beta_pdf, 0.5000, 0.1000; // CCF (2012, EJ)
    zetaw   ,   beta_pdf, 0.5000, 0.1000; // CCF (2012, EJ)
...
mode_compute=0, mode_file=Alternative1_estimation_mode,
