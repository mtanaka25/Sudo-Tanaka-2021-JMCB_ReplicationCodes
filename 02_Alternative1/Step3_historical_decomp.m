...
% A. Setting
%-------------------------------------------------------------------------
    SimCode     = 'Alternative1_HD'         ; % Name of the mod file: simulation
...
%-------------------------------------------------------------------------
    fname  = 'Historical_Decomposition_Alt1.xlsx';
    ...
    xlswrite(fname, [4 * rL_obs, Stock_Effect, Flow_Effect, Others], 'Fig7_Alt1', 'A1');
