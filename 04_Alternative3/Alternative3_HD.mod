 ...
 * Alternative3_HD.mod
 * 
 * This is the dynare code that calculates the shock decomposition based on
 * a set of parameters drawn from the posterior distribution.
 *
 * ...........................................................................
...
//Observation variables
  var dy_obs dI_obs dc_obs dN_obs dw_obs pi_obs r_obs rL_obs EXPr1_obs EXPr2_obs
      EXPr3_obs EXPr4_obs dbLCB_obs eps_QE_obs flow_obs eps_flow_obs eps_QEs_obs;

//Exogenous variables
  varexo eps_a_u eps_a_r eps_QE eps_QEs eps_z eps_zl eps_zeta eps_r eps_bL eps_g
         eps_mu eps_lmbdp eps_lmbdw eps_r1 eps_r2 eps_r3 eps_r4 eps_flow;
...
//Structual parameters
  parameters sigmau sigmar h nu tau1 tau2 tau3 tau4 eta psi zetap
    ...
    set_param_value('tau3',tau3)      ; set_param_value('eta', eta)      ;
    ...
    set_param_value('delta1', delta1) ; set_param_value('tau4', tau4)    ; 
...
//Shock parameters
  parameters rho_bL rho_QE rho_a_u rho_a_r rho_z rho_zeta rho_g rho_lmbdp
             ...
             sig_lmbdp sig_lmbdw sig_mu sig_r1 sig_r2 sig_r3 sig_r4 sig_me_pi sig_me_dw
             sig_flow;
    ...
    set_param_value('sig_me_pi', sig_me_pi) ; set_param_value('sig_me_dw', sig_me_dw); 
    set_param_value('sig_flow', sig_flow)   ;
...
//********************************************//
 ...
 //83. Observed flow Effect
   flow_obs = 100 * gamma + z + eps_flow;

 //84. Observed flow Effect Shock
   eps_flow_obs = eps_flow;

 //85. Observed QE shock
   eps_QEs_obs = eps_QEs;
...
shocks;
    ...
    var eps_flow  ; stderr sig_flow  ;
    var me_dw     ; stderr sig_me_dw ;
    var me_pi     ; stderr sig_me_pi ;
end;

varobs dy_obs dc_obs dI_obs dN_obs dw_obs pi_obs r_obs rL_obs EXPr1_obs EXPr2_obs
       EXPr3_obs EXPr4_obs dbLCB_obs eps_QE_obs flow_obs eps_flow_obs eps_QEs_obs;
...
shock_decomposition(datafile=data_86Q3to17Q4, parameter_set=calibration)RP;