...
//Structual parameters
  parameters sigmau sigmar h nu omega tau1_p tau2_p tau3_p tau4_p psi eta 
...
estimated_params;
  ...
  // standard deviation of shocks
    ...
    stderr eps_flow    , inv_gamma_pdf, 5.00, inf; // 
...
mode_compute=0, mode_file=Alternative3_estimation_mode,
mh_replic=100000, mh_nblocks=2,
mh_jscale=0.17,
smoother)y pi r rL RP RP_st RP_fl QE eQE mvCB mv;
