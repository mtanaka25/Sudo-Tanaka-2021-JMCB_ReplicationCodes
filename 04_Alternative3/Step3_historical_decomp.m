...
% A. Setting
%-------------------------------------------------------------------------
    SimCode     = 'Alternative3_HD'         ; % Name of the mod file: simulation
...
%-------------------------------------------------------------------------
    fname  = 'Historical_Decomposition_Alt3.xlsx';
    ...
    xlswrite(fname, [4 * rL_obs, Stock_Effect, Flow_Effect, Others], 'Fig7_Alt3', 'A1');
