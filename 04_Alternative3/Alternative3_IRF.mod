...
//Structual parameters
  parameters sigmau sigmar h nu tau1 tau2 tau3 tau4 eta psi zetap zetaw lmbdp
             lmbdw delta0 delta1;
    ...
    set_param_value('eta', eta)       ; set_param_value('psi', psi)      ;
    set_param_value('zetap', zetap)   ; set_param_value('zetaw', zetaw)  ; 
    set_param_value('lmbdp', lmbdp)   ; set_param_value('lmbdw', lmbdw)  ;
    set_param_value('delta0', delta0) ; set_param_value('delta1', delta1);
...
//Shock parameters
  parameters rho_bL rho_QE rho_a_u rho_a_r rho_z rho_zeta rho_g rho_lmbdp
             ...
             sig_bL sig_QE sig_QEs sig_a_u sig_a_r sig_z sig_zl sig_r sig_zeta
             sig_g sig_lmbdp sig_lmbdw sig_mu sig_r1 sig_r2 sig_r3 sig_r4
             sig_flow;
...
//Define some auxiliary variables
   ...
   //69. Sum of stock and flow effects
     QE = RP_st + RP_fl;
end;
